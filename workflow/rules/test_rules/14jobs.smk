# We tested the R package [JOBS](https://github.com/LidaWangPSU/JOBS) to integrate our sc-eQTL TensorQTL nominal data 
# with publically available data Wen et al 2024 to boost our eQTL discovery power the run SMR with boosted data. 
# The citation for JOBS is Wang et al. (2025), DOI: 10.1016/j.xgen.2025.100820
