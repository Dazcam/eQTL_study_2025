...
4. `create_query`: Formats the concatenated nominal eQTL data into an SMR query file, filtering to eGenes passing FDR ≤ 0.05, aligning SNP IDs with the reference panel, and adding sample size (N=133).
...
| :--- | :---: | :--- |
| `cat_tensorqtl_nom_snps` | 20 | 20 cell types |
| `format_gwas` | 6 | 6 GWAS traits |
| `smr` | 120 | 20 cell types × 6 GWAS |
